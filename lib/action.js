...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const shouldHandlePullRequestsAsBranches = /true/i.test(core.getInput('handle_pr_as_branch'));
        ...
        const currentBranch = shouldHandlePullRequestsAsBranches && isPullRequest
            ? GITHUB_HEAD_REF
            : (0, utils_1.getBranchFromRef)(GITHUB_REF);
